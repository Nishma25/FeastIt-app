...
function SignIn() {
  ...
  return (
    <div className="signin-container" style={{ backgroundImage: `url(${loginBackground})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'top', width: '100vw' ,  height: '100vh'}}>      <Navbar_Wrapper />
